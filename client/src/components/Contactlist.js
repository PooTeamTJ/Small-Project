        ...
        {this.props.isAuthenticated ? (
          <Container>
            <Button
              ...
              onClick={this.onGetitem.bind(this)}
            >
              {" "}
              Show Contacts{" "}
            </Button>
            <Button
              ...
              onClick={this.onClicklose.bind(this)}
            >
              {" "}
              Close contacts
            </Button>
            ...
            <ListGroup style={{ float: "left" }}>
              <TransitionGroup
                ...
                style={{ marginTop: "5rem", float: "left" }}
              >
...
export default connect(mapStateToProps, {
  ...
  updateItem,
  getItems
})(Contactlist); // connecting to getItems, deleteItems and searchItems
